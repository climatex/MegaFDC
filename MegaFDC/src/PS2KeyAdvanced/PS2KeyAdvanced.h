...
class PS2KeyAdvanced {
  public:
    ...
    /* Calls ps2_reset() which resets the buffers and states,
       after the clock has been pulled low to give time for processing the scancode.
       This does not send the reset command to the keyboard. */
    void resetBuffersStates( );
};
#endif
